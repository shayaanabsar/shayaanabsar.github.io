...
title: Shayaan Absar # the website title (if blank, full name will be used instead)
first_name: Shayaan
middle_name:
last_name: Absar
contact_note: >
...
url: https://shayaanabsar.github.io # the base hostname & protocol for your site
...
analytics:
  ...
  cloudflare: # your Cloudflare Web Analytics beacon token (32 hex characters)
enable_simple_analytics: false # Simple Analytics identifies a site by its domain, so it has no ID to set above

# For Google Search Console, see https://support.google.com/webmasters/answer/9008080?hl=en#meta_tag_verification&zippy=%2Cmeta_tag_verification
...
third_party_libraries:
  ...
  tikzjax:
    integrity:
      css: "sha256-p+CQrhSq3dnLHELDcVBFDf4whOor3w8gzLuc/pwRLyQ="
      js: "sha256-7SCmUR11IG4MkSoeLUq0pombv7oeV7yZuu7Z82e4Uy4="
    url:
      css: "https://cdn.jsdelivr.net/npm/@planktimerr/tikzjax@{{version}}/dist/fonts.css"
      js: "https://cdn.jsdelivr.net/npm/@planktimerr/tikzjax@{{version}}/dist/tikzjax.js"
    version: "1.0.8"
  tocbot:
    integrity:
