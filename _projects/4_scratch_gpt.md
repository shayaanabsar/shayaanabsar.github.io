...
<div class="repositories d-flex flex-wrap flex-md-row flex-column justify-content-between align-items-center mb-4">
  <div class="project-tags">
    ...
    <span class="badge badge-pill badge-warning">Transformers</span>
    <span class="badge badge-pill badge-info">Causal Self-Attention</span>
    <span class="badge badge-pill badge-secondary">Pre-LN</span>
  </div>
  <a href="https://github.com/shayaanabsar/gpt" target="_blank" class="btn btn-sm z-depth-0 mt-2 mt-md-0" style="border: 1px solid var(--global-divider-color);">
